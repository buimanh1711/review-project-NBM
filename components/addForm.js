...
class AddForm extends Component {
  ...
  onFinish(values) {
    ...
    this.props.addProduct(this.newProduct);
  };
  ...
  render() {
    ...
    if(this.props.product.addFormIsOpened) {
      ...
      <div className={status}>
        <Overlay>
          ...
          <div className='contentBlock'>
              <h1 style={{color: "#5D6895"}}>Add product</h1>
              <i className="far fa-times-circle closeForm-icon" onClick={ this.props.toggleAddForm }></i>
              <Form
              {...layout}
              name="new product"
...
import { addProduct, toggleAddForm } from '../rudux/actions/productActions';
